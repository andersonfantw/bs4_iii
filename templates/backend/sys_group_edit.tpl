			...
			<div id="main-content">
				...
				<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
					...
					<div class="portlet-content">
						<form action="sys_group.php?type=<{if $smarty.get.type=='add'}>do_add<{else}>do_update<{/if}>&page=<{$smarty.get.page}>" method="post" enctype="multipart/form-data" class="forms" name="form" >
							<ul>
								<li>
									<label class="desc">
								...
								<li>
									<label class="desc">
										<{$smarty.const.LANG_GROUP_EDIT_TRIAL}>
									</label>
									<div>
										<input type="checkbox" id="trial" name="trial" value="1" <{if $data.trial=='1'}>checked<{/if}> /> <{$smarty.const.LANG_GROUP_EDIT_TRIAL}>
									</div>
								</li>
								<li>
									<label class="desc">
										<{$smarty.const.LANG_GROUP_EDIT_LIMIT}>
									</label>
									<div>
										<input type="text" maxlength="10" class="field text small" id="limit" name="limit" value="<{$data.limit}>" />
									</div>
								</li>
								<li>
									<label class="desc">
