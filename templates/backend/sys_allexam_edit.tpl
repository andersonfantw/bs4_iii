...
<{block name="content"}>
			<div id="main-content">
				...
				<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
					<form action="sys_allexam.php?type=<{if $smarty.get.type=='add'}>do_add<{else}>do_update<{/if}>&page=<{$smarty.get.page}>" method="post" enctype="multipart/form-data" class="forms" name="form" >
					...
					<div class="portlet-content">
						<ul>
							...
							<li class="buttons">
								...
								<input type="button" value="<{$smarty.const.LANG_BUTTON_CANCEL}>" onclick="javascript:location.href='sys_allexam.php?q=<{$q_str}>'"/>
							</li>
						</ul>
