...
<{block name="content"}>
			<div id="main-content">
				...
				<div>
						<form action="allexam.php?type=search" method="post" class="forms" name="form" id="search">
							<ul>
								<li>
									<label  class="desc">
				...
				<div class="other">
					<div class="button float-right">
						<a href="scoreimport.php?m=1" class="btn ui-state-default"><span class="ui-icon ui-icon-circle-plus"></span><{$smarty.const.LANG_ALLEXAM_LIST_BTN_IMPORT}></a>
					</div>
