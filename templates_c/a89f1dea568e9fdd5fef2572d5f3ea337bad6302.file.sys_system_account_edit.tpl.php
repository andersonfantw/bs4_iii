<?php /* Smarty version Smarty-3.1.7, created on 2020-08-31 11:47:42
         compiled from "/var/www/html/bs4/templates/backend/sys_system_account_edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11363914125f4c72de7e2ae9-97492504%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a89f1dea568e9fdd5fef2572d5f3ea337bad6302' => 
    array (
      0 => '/var/www/html/bs4/templates/backend/sys_system_account_edit.tpl',
      1 => 1471795384,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '11363914125f4c72de7e2ae9-97492504',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5f4c72de8d930',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f4c72de8d930')) {function content_5f4c72de8d930($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
...
" id="status_bar">
				...
				<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
					<div class="portlet-header ui-widget-header"><?php echo @LANG_ADMIN_EDIT_TITLE;?>
</div>
					<div class="portlet-content">
						<form action="sys_system_account.php?type=do_update" method="post" enctype="multipart/form-data" class="forms" name="form" >
							<ul>
								<li>
									<label  class="desc">
										<?php echo @LANG_ADMIN_EDIT_ACCOUNT;?>

									</label>
									<div>
										<?php echo $_smarty_tpl->tpl_vars['data']->value['su_name'];?>

									</div>
								</li>
								<li>
									<label class="desc">
										<?php echo @LANG_ADMIN_EDIT_PASSWORD;?>
								...
								<li>
								  <label class="desc">
									<?php echo @LANG_ADMIN_EDIT_PASSWORDCONFIRM;?>
...
" onclick="javascript:history.go(-1);"/>
							...
							<input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['su_id'];?>
" />
							<input type="hidden" name="su_name" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['su_name'];?>
" />
						</form>
					</div>
				</div>
