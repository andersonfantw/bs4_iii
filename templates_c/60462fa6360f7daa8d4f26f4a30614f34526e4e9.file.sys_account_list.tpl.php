<?php /* Smarty version Smarty-3.1.7, created on 2020-10-16 10:51:39
         compiled from "/var/www/html/bs4/templates/backend/sys_account_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:789821458580d4fa7e2bed4-35831184%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '60462fa6360f7daa8d4f26f4a30614f34526e4e9' => 
    array (
      0 => '/var/www/html/bs4/templates/backend/sys_account_list.tpl',
      1 => 1471795382,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '789821458580d4fa7e2bed4-35831184',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_580d4fa80217d',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_580d4fa80217d')) {function content_580d4fa80217d($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
...
" id="status_bar">
				...
				<?php }?>
				<div class="title">
					<h3><?php echo @LANG_SYSACCOUNT_LIST_TITLE;?>
</h3>		
				</div>
				<div>
				<form action="sys_account.php?type=search" method="post" class="forms" name="form" id="search">
					<ul>
						<li>
							<label  class="desc">
								<?php echo @LANG_SYSACCOUNT_LIST_SEARCH;?>
...
" class="submit" />
				...
				<div class="other">						
						<div class="button float-right">
							<a href="sys_account.php?type=add"  class="btn ui-state-default"><span class="ui-icon ui-icon-circle-plus"></span><?php echo @LANG_SYSACCOUNT_LIST_BTN_ADD;?>
</a>
							<?php if (LicenseManager::chkAuth(@MEMBER_SYSTEM,MemberSystemEnum::Import)||LicenseManager::chkAuth(@MEMBER_SYSTEM,MemberSystemEnum::Regist)){?>
								<?php if (LicenseManager::chkAuth(@BACKEND_IMPORT_MODE,ImportManagerModeEnum::MANAGER)){?>
								<?php if (@ENABLE_IMPOERT){?><a href="sys_import.php" class="btn ui-state-default"><span class="ui-icon ui-icon-arrowreturnthick-1-s"></span><?php echo @LANG_SYSACCOUNT_LIST_BTN_IMPORT;?>
</a><?php }?>
								<?php if (@ENABLE_EXPOERT){?><a href="sys_import.php?cmd=export" class="btn ui-state-default"><span class="ui-icon ui-icon-arrowreturnthick-1-n"></span><?php echo @LANG_SYSACCOUNT_LIST_BTN_EXPORT;?>
</a><?php }?>
								<?php }?>
							<?php }?>
						</div>
				...
				<div class="hastable">
					<table cellspacing="0">
						<thead>
							<tr>								
								<td><?php echo @LANG_SYSACCOUNT_LIST_COL_NAME;?>
</td>
								<td><?php echo @LANG_SYSACCOUNT_LIST_COL_ACCOUNT;?>
</td>
						...
						<?php echo $_smarty_tpl->tpl_vars['sys_account_list_data_html']->value;?>
