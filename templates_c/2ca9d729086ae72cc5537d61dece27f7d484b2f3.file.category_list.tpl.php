<?php /* Smarty version Smarty-3.1.7, created on 2019-12-23 22:39:17
         compiled from "/var/www/html/bs4/templates/backend/category_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:114846003057cfcf8ac53007-10830095%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ca9d729086ae72cc5537d61dece27f7d484b2f3' => 
    array (
      0 => '/var/www/html/bs4/templates/backend/category_list.tpl',
      1 => 1501480459,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '114846003057cfcf8ac53007-10830095',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57cfcf8ae04ed',
  'variables' => 
  array (
    'bsname' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_57cfcf8ae04ed')) {function content_57cfcf8ae04ed($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/Storage/var/www/html/bs4/libs/Smarty/libs/plugins/modifier.replace.php';
...
" id="status_bar">
				...
				<?php }?>
				<div class="title">
					<h3><?php echo @LANG_CATE;?>
</h3>		
				</div>
					<div class="other">						
						<div class="button float-right">
							<?php if ($_GET['pid']!=0){?><a href="category.php"  class="btn ui-state-default"><span class="ui-icon ui-icon-arrowreturnthick-1-w"></span><?php echo @LANG_CATE_BTN_RETURN;?>
</a><?php }?>
							<a href="category.php?type=add&pid=<?php echo $_GET['pid'];?>
"  class="btn ui-state-default"><span class="ui-icon ui-icon-circle-plus"></span><?php echo @LANG_CATE_BTN_ADD;?>
</a>
							<?php if (LicenseManager::chkAuth(@MEMBER_SYSTEM,MemberSystemEnum::Import)||LicenseManager::chkAuth(@MEMBER_SYSTEM,MemberSystemEnum::Regist)){?>
								<?php if (LicenseManager::chkAuth(@BACKEND_IMPORT_MODE,ImportManagerModeEnum::CATEGORY)){?>
								<?php if (@ENABLE_IMPOERT){?><a href="import.php"  class="btn ui-state-default"><span class="ui-icon ui-icon-arrowreturnthick-1-s"></span><?php echo @LANG_CATE_BTN_IMPORT;?>
</a><?php }?>
								<?php if (@ENABLE_EXPOERT){?><a href="import.php?cmd=export"  class="btn ui-state-default"><span class="ui-icon ui-icon-arrowreturnthick-1-n"></span><?php echo @LANG_CATE_BTN_EXPORT;?>
</a><?php }?>
								<?php }?>
							<?php }?>
						</div>
				...
				<div class="hastable">
					<table cellspacing="0">
						<thead>
							<tr>
								<td>No</td>
								<td><?php if ($_GET['pid']!=0){?><?php echo @LANG_CATE_LIST_COL_SUBNAME;?>
<?php }else{ ?><?php echo @LANG_CATE_LIST_COL_MAINNAME;?>
<?php }?></td>
								<td><?php echo @LANG_CATE_LIST_COL_DESC;?>
</td>
								<td><?php echo @LANG_CATE_LIST_COL_ORDER;?>
</td>
                <td><?php if ($_GET['pid']!=0){?><?php echo @LANG_CATE_LIST_COL_BELONG;?>
<?php }else{ ?><?php echo @LANG_CATE_LIST_COL_TOGO_SUBCATE;?>
<?php }?></td>
...
?>   
							<tr<?php if (!(1 & $_smarty_tpl->getVariable('smarty')->value['foreach']['myloop']['iteration'])){?> class="alt"<?php }?>>
								<td><?php echo $_smarty_tpl->tpl_vars['val']->value['c_id'];?>
</td>
								<td>
									<?php echo $_smarty_tpl->tpl_vars['val']->value['c_name'];?>
<br />
									<?php echo $_smarty_tpl->tpl_vars['val']->value['c_key'];?>

								</td>
                <td>
                  <?php echo $_smarty_tpl->tpl_vars['val']->value['c_description'];?>
<br />
                  <a href="<?php echo @HttpDomain;?>
<?php echo @WEB_URL;?>
/<?php echo common::getcookie('acc');?>
/<?php echo common::getcookie('bs');?>
/bs/#/?cid=<?php echo $_smarty_tpl->tpl_vars['val']->value['c_id'];?>
" target="_new">
										<?php echo @HttpDomain;?>
<?php echo @WEB_URL;?>
/<?php echo common::getcookie('acc');?>
...
/bs/#/?cid=<?php echo $_smarty_tpl->tpl_vars['val']->value['c_id'];?>
                ...
                <td>
                  <?php echo $_smarty_tpl->tpl_vars['val']->value['c_order'];?>

                </td>
                <td>
                  <?php if ($_smarty_tpl->tpl_vars['val']->value['c_parent_id']==0){?>
                    <a href="category.php?pid=<?php echo $_smarty_tpl->tpl_vars['val']->value['c_id'];?>
"><?php echo @LANG_CATE_LIST_COL_TOGO_SUBCATE;?>
</a>
                  <?php }else{ ?>
                    <?php echo $_smarty_tpl->tpl_vars['val']->value['c_parent_name'];?>

                  <?php }?>
                </td>
								<td>
									<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="<?php echo @LANG_BTNHINT_EDIT;?>
" href="category.php?type=edit&id=<?php echo $_smarty_tpl->tpl_vars['val']->value['c_id'];?>
...
" href="category.php?type=delete&id=<?php echo $_smarty_tpl->tpl_vars['val']->value['c_id'];?>
...
">
									...
									<?php }?>
									<?php if ($_smarty_tpl->tpl_vars['val']->value['c_parent_id']>0){?>
										<a class="btn_no_text btn ui-state-default ui-corner-all tooltip upload" title="<?php echo @LANG_BTNHINT_UPLOAD;?>
" href="ecocatconvert.php?id=<?php echo $_smarty_tpl->tpl_vars['val']->value['c_id'];?>
&pid=<?php echo $_GET['pid'];?>
&cn=<?php echo $_smarty_tpl->tpl_vars['val']->value['c_name'];?>
">
