<?php /* Smarty version Smarty-3.1.7, created on 2020-09-12 22:05:34
         compiled from "/var/www/html/bs4/templates/backend/sys_queue_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:716201036595bd5a8d421c2-62167432%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '350320e195d0c6cb3cb03366d7dd3bb32e51244f' => 
    array (
      0 => '/var/www/html/bs4/templates/backend/sys_queue_list.tpl',
      1 => 1533018927,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '716201036595bd5a8d421c2-62167432',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_595bd5a8e0971',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_595bd5a8e0971')) {function content_595bd5a8e0971($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
...
" id="status_bar">
				...
				<?php }?>
				<div class="title">
					<h3><?php echo @LANG_UPLOADQUEUE;?>
</h3>		
				</div>
				<div class="other">
					<div class="button float-right">
					<?php if ($_GET['type']==''){?>
						<a href="sys_queue.php?type=add" class="btn ui-state-default"><span class="ui-icon ui-icon-circle-plus"></span><?php echo @LANG_UPLOADQUEUE_LIST_BTN_ADD;?>
</a>
					<?php }?>
					</div>
				...
				<div class="hastable">
					...
					<table cellspacing="0">
						<thead>
							<tr>
								<td><?php echo @LANG_UPLOADQUEUE_LIST_COL_CREATEDATE;?>
</td>
								<td><?php echo @LANG_UPLOADQUEUE_LIST_COL_ID;?>
</td>
								<td><?php echo @LANG_UPLOADQUEUE_LIST_COL_NAME;?>
</td>
								<td><?php echo @LANG_UPLOADQUEUE_LIST_COL_RETRY;?>
</td>
								<td><?php echo @LANG_UPLOADQUEUE_LIST_COL_DATA;?>
</td>
						...
						<?php echo $_smarty_tpl->tpl_vars['sys_queue_list_data_html']->value;?>
