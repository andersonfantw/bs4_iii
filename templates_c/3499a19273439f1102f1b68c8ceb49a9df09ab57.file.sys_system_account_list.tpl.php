<?php /* Smarty version Smarty-3.1.7, created on 2020-10-16 10:36:06
         compiled from "/var/www/html/bs4/templates/backend/sys_system_account_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:827517920584a3fcbae7982-55612636%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3499a19273439f1102f1b68c8ceb49a9df09ab57' => 
    array (
      0 => '/var/www/html/bs4/templates/backend/sys_system_account_list.tpl',
      1 => 1471795384,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '827517920584a3fcbae7982-55612636',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_584a3fcbbed79',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_584a3fcbbed79')) {function content_584a3fcbbed79($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
...
" id="status_bar">
				...
				<?php }?>
				<div class="title">
					<h3><?php echo @LANG_ADMIN_LIST_TITLE;?>
</h3>		
				</div>
				<div class="hastable">
					<table cellspacing="0">
						<thead>
							<tr>								
								<td><?php echo @LANG_ADMIN_LIST_ACCOUNT;?>
</td>
								<td><?php echo @LANG_ADMIN_LIST_SETPASSWORD;?>
</td>
							</tr>
						</thead>
						<tbody>
...
?>   
							<tr<?php if (!(1 & $_smarty_tpl->getVariable('smarty')->value['foreach']['myloop']['iteration'])){?> class="alt"<?php }?>>
								<td>
									<?php echo $_smarty_tpl->tpl_vars['val']->value['su_name'];?>

								</td>
								<td>
									<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="<?php echo @LANG_ADMIN_LIST_SETPASSWORDTEXT;?>
" href="sys_system_account.php?type=edit&id=<?php echo $_smarty_tpl->tpl_vars['val']->value['su_id'];?>
">
									<?php echo @LANG_ADMIN_LIST_SETPASSWORDTEXT;?>
