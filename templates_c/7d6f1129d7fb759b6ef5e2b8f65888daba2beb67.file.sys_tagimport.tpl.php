<?php /* Smarty version Smarty-3.1.7, created on 2017-11-21 23:14:03
         compiled from "/var/www/html/bs4/templates/backend/sys_tagimport.tpl" */ ?>
<?php /*%%SmartyHeaderCode:712885025595bd284156580-62392544%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7d6f1129d7fb759b6ef5e2b8f65888daba2beb67' => 
    array (
      0 => '/var/www/html/bs4/templates/backend/sys_tagimport.tpl',
      1 => 1510296474,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '712885025595bd284156580-62392544',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_595bd28424dd5',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_595bd28424dd5')) {function content_595bd28424dd5($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
...
<script src="<?php echo @WEB_URL;?>
/plugin/tag/scripts/loader_uploadtag.js" type="text/javascript"></script>
		...
		<ul id="navigation" class="sf-navbar">
			...
			<li>
				...
				<ul>
					...
					<li>
						<a href="sys_queue.php?type=err"><?php echo @LANG_UPLOADQUEUE_ERRLIST;?>
</a>
					</li>
				</ul>
			</li>
...
" id="status_bar">
				...
				<div class="title">
					<h3>
					<?php if ($_GET['m']=='1'){?>
						<?php echo @LANG_TAG_IMPORT;?>

					<?php }else{ ?>
						<?php echo @LANG_DIC_IMPORT;?>
