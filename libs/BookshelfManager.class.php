...
*/
  ...
  function doEcocatUpdate($type,$bs_code,$uid,$cid='',$processid='',$bsss_id=''){
		...
		foreach($ecocat as $key=>$val)
		{
		  ...
		  //ecocat���ADB��(���e���g�qecocat�פJ�L)�B�W�[�� => DB���������y�����W�[����
		  //ecocat���ADB��(���e���g�qecocat�פJ�L)�B�U�[�� => DB���������y�����U�[����
		...
		//ecocat�S��(�U�[�F)�ADB��(���e���g�qecocat�פJ�L)�B�W�[�� => DB���������y�n�ܦ��U�[
		//ecocat�S��(�U�[�F)�ADB��(���e���g�qecocat�פJ�L)�B�U�[�� => DB���������y�����U�[����
