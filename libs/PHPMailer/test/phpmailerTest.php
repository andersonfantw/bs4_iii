...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        if (array_key_exists('mail_from', $_REQUEST)) {
            ...
            $this->Mail->From = 'support@ttii.com.tw';
        }
        $this->Mail->FromName = 'support';
        $this->Mail->Sender = 'support@ttii.com.tw';
        ...
        $this->Mail->Helo = 'smtp.gmail.com';
        $this->Mail->SMTPAuth = true;
	$this->Mail->SMTPSecure = 'ssl';
        $this->Mail->Username = 'support@ttii.com.tw';
        $this->Mail->Password = 'ttii2971768578#';
