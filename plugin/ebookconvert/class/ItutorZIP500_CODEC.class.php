...
class ItutorZIP500_CODEC implements iBSFile_CODEC{
	const Name='itutor500';
			...
			if(is_file($tmpfolder.$file)){
				...
				*/
				...
				if($handle){
					...
					$f_exist=(strpos($line,'Generated by iTutor 5.0.0')!==false);
				}
				fclose($handle);
			}
		}
		if($f_exist){
			$this->zipFormat = ConvertModeEnum::ITUTOR500_ZIP;
