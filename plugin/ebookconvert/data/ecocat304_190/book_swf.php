...
<body bgcolor="#FFFFFF" onLoad="initWindow()" onResize="resizeWindow()" ONDRAGSTART="window.event.returnValue=false" onSelectStart="event.returnValue=false" ONCONTEXTMENU="window.event.returnValue=false">
<div align="center">
