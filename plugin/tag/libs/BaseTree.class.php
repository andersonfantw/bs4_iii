...
class BaseTree{
	...
	public function getNodeByValue($value){
		$this->_val=$value;
		return array_filter($this->hash,array($this,"_getTagByValue"));
	}
	...
	public function hasTagByValue($val){
		return in_array($val,$this->hash,true);
	}
	private function _getTagByValue($val){
		return($val->data['val']==$this->_val);
	}
