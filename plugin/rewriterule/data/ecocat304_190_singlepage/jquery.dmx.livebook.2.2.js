...
(function($) {
	...
	//Anderson 20181009
	_rate = 1.68; 
        var x = parseInt(x1) * ps * params.basescale * _rate;
        var y = parseInt(y1) * ps * params.basescale * _rate;

        var w = (parseInt(x2) - otbw) * ps * params.basescale * _rate;
        var h = (parseInt(y2) - otbw) * ps * params.basescale * _rate;
	...
	//Anderson 20181009 (Add _rate)	
        var x = parseInt(x1) / params.searchall.datapntratio * ps * params.basescale * _rate;
        var y = parseInt(y1) / params.searchall.datapntratio * ps * params.basescale * _rate;

        var w = (parseInt(x2) - parseInt(x1)) / params.searchall.datapntratio * ps * params.basescale * _rate;
        var h = (parseInt(y2) - parseInt(y1)) / params.searchall.datapntratio * ps * params.basescale * _rate;
...
console.log(status.swipe);
console.log(status.gesture);
...
console.log('slidedragmove'); 
        ...
        slidedragterminate: function () {
            ...
            var md;
            var cp = status.curbasepage;
console.log('slidedragterminate'); 
            status.swipe = false;
...
console.log('sliding=false');
	    ...
	    _rate = 1.68; 
            l.each(function(){
                ...
                var x = parseInt(x1) * params.pscale * params.basescale * _rate;
                var y = parseInt(y1) * params.pscale * params.basescale * _rate;
                
                var w = (parseInt(x2) - otbw) * params.pscale * params.basescale * _rate;
                var h = (parseInt(y2) - otbw) * params.pscale * params.basescale * _rate;
	    ...
	    _rate = 1.68;
            $(".page[rel=" + p + "] .link_rect", selectors.paper_frame).each(function(){
                ...
                var x = parseInt(x1) * params.zscale.scale * _rate;
                var y = parseInt(y1) * params.zscale.scale * _rate;
                
                var w = (parseInt(x2) - otbw) * params.zscale.scale * _rate;
                var h = (parseInt(y2) - otbw) * params.zscale.scale * _rate;
	    ...
	    _rate = 1.7;
            for (var i = 0, l = _match.length; i < l; i++) {
                ...
                var y2 = _match[i]["y2"];
                //Anderson 20181009 (Add _rate)
                var x = parseInt(x1) / params.searchall.datapntratio * params.pscale * params.basescale * _rate;
                var y = parseInt(y1) / params.searchall.datapntratio * params.pscale * params.basescale * _rate;

                var w = (parseInt(x2) - parseInt(x1)) / params.searchall.datapntratio * params.pscale * params.basescale * _rate;
                var h = (parseInt(y2) - parseInt(y1)) / params.searchall.datapntratio * params.pscale * params.basescale * _rate;
	    ...
	    _rate = 1.5;
            for (var i = 0, l = _match.length; i < l; i++) {
                ...
                if ($("#zoom_frame div.page[rel=" + p + "]").length) {
                    ...
                    var x = parseInt(x1) / params.searchall.datapntratio * params.zscale.scale * _rate;
                    var y = parseInt(y1) / params.searchall.datapntratio * params.zscale.scale * _rate;

                    var w = (parseInt(x2) - parseInt(x1)) / params.searchall.datapntratio * params.zscale.scale * _rate;
                    var h = (parseInt(y2) - parseInt(y1)) / params.searchall.datapntratio * params.zscale.scale * _rate;
