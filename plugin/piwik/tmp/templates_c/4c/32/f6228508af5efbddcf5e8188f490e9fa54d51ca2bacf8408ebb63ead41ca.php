...
class __TwigTemplate_4c32f6228508af5efbddcf5e8188f490e9fa54d51ca2bacf8408ebb63ead41ca extends Twig_Template
{
    ...
    ";
            // line 14
            if ((array_key_exists("properties", $context) &&  !twig_test_empty($this->getAttribute($this->getContext($context, "properties"), "tooltip_metadata_name", array())))) {
                echo "title=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "row"), "getMetadata", array(0 => $this->getAttribute($this->getContext($context, "properties"), "tooltip_metadata_name", array())), "method"), "html", null, true);
                echo "\"";
            }
            echo ">
        ";
...
";
        ...
        if (twig_in_filter($this->getContext($context, "column"), twig_get_array_keys_filter($this->getContext($context, "totals")))) {
            ...
            // line 29
            echo "    ";
            if (((array_key_exists("siteSummary", $context) &&  !twig_test_empty($this->getContext($context, "siteSummary"))) && $this->getAttribute($this->getContext($context, "siteSummary"), "getFirstRow", array()))) {
                // line 30
                echo "        ";
                $context["siteTotal"] = $this->getAttribute($this->getAttribute($this->getContext($context, "siteSummary"), "getFirstRow", array()), "getColumn", array(0 => $this->getContext($context, "column")), "method");
                // line 31
                echo "    ";
            } else {
                // line 32
