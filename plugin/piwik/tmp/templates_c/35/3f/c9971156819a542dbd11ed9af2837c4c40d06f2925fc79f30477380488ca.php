...
class __TwigTemplate_353fc9971156819a542dbd11ed9af2837c4c40d06f2925fc79f30477380488ca extends Twig_Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["action"]) {
            ...
            ";
                ...
                foreach ($context['_seq'] as $context["id"] => $context["customVariable"]) {
                    ...
                    // line 9
                    echo "                - ";
                    echo $this->getAttribute($context["customVariable"], $this->getContext($context, "name"), array(), "array");
                    echo " ";
                    if ((twig_length_filter($this->env, $this->getAttribute($context["customVariable"], $this->getContext($context, "value"), array(), "array")) > 0)) {
                        echo " = ";
                        echo $this->getAttribute($context["customVariable"], $this->getContext($context, "value"), array(), "array");
                    }
                    // line 10
                    echo "
                ";
        ...
        ";
            ...
            <span ";
                ...
                if (($this->getAttribute($context["action"], "type", array()) == "ecommerceOrder")) {
                    ...
                    echo ": ";
                    echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["action"], "revenue", array()), $this->getAttribute($this->getContext($context, "clientSideParameters"), "idSite", array())));
                    echo "
";
                    // line 45
                    if ( !twig_test_empty($this->getAttribute($context["action"], "revenueSubTotal", array()))) {
                        ...
                        echo ": ";
                        echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["action"], "revenueSubTotal", array()), $this->getAttribute($this->getContext($context, "clientSideParameters"), "idSite", array())));
                    }
                    // line 46
                    echo "
";
                    ...
                    if ( !twig_test_empty($this->getAttribute($context["action"], "revenueTax", array()))) {
                        ...
                        echo ": ";
                        echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["action"], "revenueTax", array()), $this->getAttribute($this->getContext($context, "clientSideParameters"), "idSite", array())));
                    }
                    // line 48
                    echo "
";
                    ...
                    if ( !twig_test_empty($this->getAttribute($context["action"], "revenueShipping", array()))) {
                        ...
                        echo ": ";
                        echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["action"], "revenueShipping", array()), $this->getAttribute($this->getContext($context, "clientSideParameters"), "idSite", array())));
                    }
                    // line 50
                    echo "
";
                    ...
                    if ( !twig_test_empty($this->getAttribute($context["action"], "revenueDiscount", array()))) {
                        ...
                        echo ": ";
                        echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["action"], "revenueDiscount", array()), $this->getAttribute($this->getContext($context, "clientSideParameters"), "idSite", array())));
                    }
                ...
                if ( !twig_test_empty($this->getAttribute($context["action"], "itemDetails", array()))) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                        ...
                        echo ": ";
                        echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["product"], "price", array()), $this->getAttribute($this->getContext($context, "clientSideParameters"), "idSite", array())));
                        echo "
                            </li>
                        ";
                    }
...
$this->getContext($context, "previousAction", true), "url", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getContext($context, "previousAction", true), "url", array()), false)) : (false)) == $this->getAttribute($context["action"], "url", array())))) {
                        // line 102
                        echo "                    ";
                        // line 103
                        echo "                ";
                ...
                <span style=\"margin-left: 9px;\">";
                    // line 116
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "clientSideParameters"), "pageUrlNotDefined", array()), "html", null, true);
                    echo "</span>
                </p>
            ";
                }
