...
class __TwigTemplate_c60cc59f59c02be1c473f13355ab4a3e33cbad1815848bc89fd04768abbfd8fc extends Twig_Template
{
    ...
    <div class=\"dataTableFooterNavigation\">
        ...
        <label for=\"widgetSearch_";
            ...
            echo " ";
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "visualization", true), "config", array(), "any", false, true), "translations", array(), "any", false, true), "label", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "visualization", true), "config", array(), "any", false, true), "translations", array(), "any", false, true), "label", array()), "")) : ("")), "html", null, true);
            echo "</label>
        ...
        if ($this->getAttribute($this->getContext($context, "properties"), "show_footer_icons", array())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["footerIconGroup"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["footerIcon"]) {
                    // line 35
                    echo "                        ";
                    $context["isActiveEcommerceView"] = ($this->getAttribute($this->getContext($context, "clientSideParameters", true), "abandonedCarts", array(), "any", true, true) && ((($this->getAttribute(                    // line 36
$context["footerIcon"], "id", array()) == "ecommerceOrder") && ($this->getAttribute($this->getContext($context, "clientSideParameters"), "abandonedCarts", array()) == 0)) || (($this->getAttribute(                    // line 37
$context["footerIcon"], "id", array()) == "ecommerceAbandonedCart") && ($this->getAttribute($this->getContext($context, "clientSideParameters"), "abandonedCarts", array()) == 1))));
                    // line 38
                    echo "                        <span>
                            ";
                    // line 39
            ...
            echo ":
                    ";
            // line 62
            $context["requestParams"] = twig_jsonencode_filter($this->getAttribute($this->getContext($context, "properties"), "request_parameters_to_modify", array()));
            // line 63
            echo "                    <a target=\"_blank\" requestParams=\"";
            echo twig_escape_filter($this->env, $this->getContext($context, "requestParams"), "html_attr");
            echo "\" methodToCall=\"";
