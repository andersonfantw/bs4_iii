...
class __TwigTemplate_9574f335513ba9463c481998978c93dab935f6066dd13f22f40b238a75a09f90 extends Twig_Template
{
    ...
    {
        // line 1
        $context["cloudColumn"] = $this->getAttribute($this->getAttribute($this->getContext($context, "properties"), "columns_to_display", array()), 1, array(), "array");
        // line 2
...
";
    ...
    ";
            // line 7
            if ( !($this->getAttribute($this->getAttribute($this->getContext($context, "labelMetadata"), $this->getAttribute($context["value"], "word", array()), array(), "array"), "url", array()) === false)) {
                // line 8
                echo "        <a href=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "labelMetadata"), $this->getAttribute($context["value"], "word", array()), array(), "array"), "url", array()), "html", null, true);
                echo "\" rel=\"noreferrer\" target=\"_blank\">
    ";
            }
            // line 10
            echo "    ";
            if ( !($this->getAttribute($this->getAttribute($this->getContext($context, "labelMetadata"), $this->getAttribute($context["value"], "word", array()), array(), "array"), "logo", array()) === false)) {
                // line 11
                echo "        <img src=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "labelMetadata"), $this->getAttribute($context["value"], "word", array()), array(), "array"), "logo", array()), "html", null, true);
                echo "\" width=\"";
