...
var ScoreImportAction = function(panel){
	$('#body').prepend(panel);

	var _convert_allowfiletype;
	var _convert_filetypes = {'infoacer':'.xls'};

	ScoreImportAPIHandler.getStatusCode('statuscode',systemEnv.isBackend,function(_convert_status_code){
